              ...
              <?php if ($auth::isAuth()) : ?>
                ...
                <div class="d-flex text-align-center align-items-center space-between">
                    ...
                    <div id="btn-nav">
                      ...
                      <span class="span-word" id="word1"></span>
                    </div>
            

                  <div class="dropdown custom-link">
                    <a class="dropdown-toggle btn button btn-secondary" href="" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                      Mon compte
                    ...
                    <ul class="dropdown-menu " aria-labelledby="dropdownMenuLink">
                      ...
                      <li><a class="dropdown-item custom-link" href="/mes_reservations<?= Session::get(Session::USER)->id ?>>">Mes réservation</a></li>
                      <li>
                        <hr class="dropdown-divider">
                      </li>
